...
#include "esp_lcd_panel_st7789.h" //"esp_lcd_touch_tt21100.h"
...
#define EXAMPLE_LCD_GPIO_RST        (GPIO_NUM_11)
#define EXAMPLE_LCD_GPIO_DC         (GPIO_NUM_10)
#define EXAMPLE_LCD_GPIO_CS         (GPIO_NUM_18)
#define EXAMPLE_LCD_GPIO_BL         (GPIO_NUM_22)
